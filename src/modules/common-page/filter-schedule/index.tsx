...
export const ScheduleFilter = ({ layoutService }: LayoutPanelComponent) => {
    const {
        txt,
        filter = [],
        currentFilter,
    ...
    return (
        ...
        >
            <FilterPanel
                ...
                metaPath="gotecq.data-foundation/scheduler-retrieve-datapack/~meta"
            />
        </CollapsiblePanel>
    );
};